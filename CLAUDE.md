...
Pipeline data complet, 1067 entités, ~500 images, 355 tests, 26 migrations. Tous les phases P0→P9 livrées + ROADMAP horizon court / moyen consommé. Voir [ROADMAP.md](ROADMAP.md) pour ce qui reste, [MIGRATION_POSTGRES.md](MIGRATION_POSTGRES.md) pour le plan de scale.
